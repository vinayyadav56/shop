    ...
    <section className="bg-white">
      <div className="mx-auto grid max-w-7xl gap-10 px-5 py-12 sm:px-8 lg:grid-cols-[0.85fr_1.4fr] lg:items-center lg:gap-12 lg:py-16">
        ...
        <div>
          ...
          <h2 className="font-cormorant mt-3 text-[2.4rem] font-bold not-italic leading-[1.05] text-forest-900 sm:text-[3rem]">
          ...
          <Link
            href="/plants/search"
            className="mt-7 inline-flex items-center gap-2 rounded-md bg-forest-800 px-6 py-3 text-[11.5px] font-semibold uppercase tracking-[0.12em] text-white transition hover:bg-forest-700"
          >
        ...
        <div className="relative min-w-0">
          ...
          >
            {CARDS.map((c) => (
              <div
                key={c.title}
                className="w-[68%] shrink-0 snap-start overflow-hidden rounded-xl border border-kraft-200/70 bg-white shadow-[0_12px_30px_-22px_rgba(34,48,26,0.3)] sm:w-[42%] lg:w-[24%]"
              >
