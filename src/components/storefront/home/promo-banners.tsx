      ...
      <div className="container mx-auto grid max-w-7xl gap-5 px-5 py-6 sm:px-8 lg:grid-cols-2">
        ...
        <div className="grid min-h-[260px] grid-cols-1 overflow-hidden rounded-3xl bg-gradient-to-r from-[#081209] via-[#0E2415] to-forest-700 sm:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="relative h-[200px] min-h-0 sm:h-full sm:min-h-[220px]">
            ...
            />
            <div className="absolute inset-y-0 left-0 hidden w-16 bg-gradient-to-r from-[#0E2415] to-transparent sm:block" />
            <div className="absolute inset-x-0 top-0 h-10 bg-gradient-to-b from-[#0E2415] to-transparent sm:hidden" />
          </div>
        </div>
