...
const CheckoutDigitalPage = () => {
  ...
  return (
    <>
      ...
      <div className="bg-[#F8F7F2] px-4 py-8 lg:py-10 lg:px-8 xl:py-14 xl:px-16 2xl:px-20">
...
const getLayout = (page: React.ReactElement) =>
  getSiteLayout(<div className="min-h-screen bg-[#F8F7F2]">{page}</div>);
...
export function PageBody(props: any) {
  const page = <CheckoutDigitalPage {...props} />;
  const withLayout = (CheckoutDigitalPage as any).getLayout ? (CheckoutDigitalPage as any).getLayout(page) : page;
