...
export function PageBody(props: any) {
  const page = <CustomerRefundPolicyPage {...props} />;
  const withLayout = (CustomerRefundPolicyPage as any).getLayout ? (CustomerRefundPolicyPage as any).getLayout(page) : page;
  return withLayout;
}
